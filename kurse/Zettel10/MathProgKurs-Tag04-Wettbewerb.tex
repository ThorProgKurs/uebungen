...
\begin{aufg}
\begin{enumerate}
\item Implementiere für $x \in \R$ und $n \in \N$ eine Potenzfunktion $x^n=$ \verb|power(x, n)| mit der folgenden Double-and-Add-Methode: \[
...
\item* In den Übungen wird an der Tafel stehen, wie man im Programm die Zeit messen kann. Vergleiche die Laufzeiten der 3 Funktionen.
\end{enumerate}
\end{aufg}
...
\begin{enumerate}
  ...
  \item Fakultät $n!$ für $n \in \N$
  \item für die $k$-te Wurzel aus $x\in \R_{\ge 0}$ mit $k \in \R_+$
