...
\begin{aufg}
Für $a \in \mathbb{R}^+$ und $n\in\mathbb{N}\cup\{0\}$ konvergiert die Folge $(a_n)$ mit $a_0 = a$ und
...
\begin{aufg}
Berechne die Summe der ersten $n$ ungeraden Zahlen mit einer Schleife. Wie ist die Ausgabe für $n = 1, \ldots ,15$. Was fällt dir auf? Könnte man diese Aufgabe nun also effizienter programmieren?
\end{aufg}
